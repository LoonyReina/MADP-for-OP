...
class ActionKind(str, Enum):
    ...
    RECONCILE_TERMINAL_RESULT = "reconcile_terminal_result"
    ...
    REGISTER_SOLVER_DIAGNOSTIC = "register_solver_diagnostic"
...
class GateDecision:
    ...
    def action_id(self) -> str:
        ...
        descriptor = self.action_descriptor or self.row.action_descriptor
        ...
        return "|".join(
            [
                ...
                self.action.value,
                descriptor_identity or "no-descriptor",
            ]
        )
