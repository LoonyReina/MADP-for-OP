...
from ascendop_daemon.workflow.case_tree import copy_tree_without_symlinks
...
def materialize_casegen_cache_snapshot(
    ...
    *,
    ...
    workflow = workflow or _workflow_module()
    validator_support = (
...
def _workflow_module() -> Any:
    raise EngineJobBuildError(
        "casegen fusion adapter was not supplied by the composition root"
    )
