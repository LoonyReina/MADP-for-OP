...
LOCAL_SERVICES = {
    ...
    "workflow-coordinator": (
        "workflow",
        ["typed-workflow-action", "board-revision-idempotency"],
    ),
    "workflow-executor": (
        "workflow",
        ["typed-handler-only", "process-identity", "action-heartbeat"],
    ),
    ...
    "control-command-worker": (
        "management",
        ["typed-command-only", "lease-fenced", "idempotent-handler"],
    ),
