...
VARIABLE_REGISTRY_PATH = Path("docs/flow_v4/variables.json")
...
CONFIG_BINDINGS = {
    ...
    "transport.git_operation_lock_timeout_seconds": "flow_v3_git_operation_lock_timeout_seconds",
    "transport.dispatch_claim_ttl_seconds": "flow_v3_dispatch_claim_ttl_seconds",
